    ...
    <div>
      <Container>
        <div className='md:px-12'>
          <h1>Политика по использованию персональных данных</h1>
          <p>
            ...
            Оператор может получить о посетителях веб-сайта https://astraway.ru.
            ...
            сетевому адресу https://astraway.ru. 2.4. Информационная система
            ...
            Пользователю веб-сайта https://astraway.ru. 2.9. Персональные
            ...
            посетитель веб-сайта https://astraway.ru. 2.11. Предоставление
            ...
            письмо на адрес электронной почты info@astraway.ru с пометкой «Отказ
            ...
            на сайте https://www.astraway.ru или направленные Оператору
            ...
            электронной почты Оператора info@astraway.ru с пометкой
            ...
            на электронный адрес Оператора info@astraway.ru с пометкой «Отзыв
            ...
            почты info@astraway.ru 14.2. В данном документе будут отражены любые
            ...
            Интернет по адресу https://www.astraway.ru/confidentiality.
          </p>
        </div>
      </Container>
    </div>
